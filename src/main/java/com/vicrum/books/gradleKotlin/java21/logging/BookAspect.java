package com.vicrum.books.gradleKotlin.java21.logging;

import com.vicrum.books.gradleKotlin.java21.app.config.AppConfig;
...
public class BookAspect {
    ...
    @Pointcut("execution(public * com.vicrum.books.gradleKotlin.java21.service.BookServiceImplementation.*(..))")
    ...
    @AfterReturning(pointcut = "execution(public * com.vicrum.books.gradleKotlin.java21.service.BookServiceImplementation.*(..))", returning = "result")
    ...
    @AfterReturning("execution(public * com.vicrum.books.gradleKotlin.java21.service.BookServiceImplementation.delete(..))")
